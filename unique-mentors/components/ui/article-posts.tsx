...
type GridSectionProps = {
  ...
  posts?: GridArticlePost[];
  className?: string;
  onPostClick?: (post: GridArticlePost) => void;
};

export function ArticlePostsGrid({
  title,
  description,
  backgroundLabel,
        ...
        {posts.map((post, index) => {
          ...
          return (
            <Link
              ...
              data-analytics-location="article_grid"
...
export const Component = ArticlePostsGrid;
