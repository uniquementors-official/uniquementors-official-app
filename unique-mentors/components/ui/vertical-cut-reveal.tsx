  ...
  (
    ...
    const getStaggerDelay = useCallback(
      (index: number) => {
        ...
        if (staggerFrom === "random") return Math.abs(Math.floor(total * 0.5) - index) * staggerDuration;
          ...
          return (
            ...
            >
              {wordObj.characters.map((char, charIndex) => (
                <span className={cn("relative whitespace-pre-wrap", elementLevelClassName)} key={`${char}-${charIndex}`}>
                  <motion.span
