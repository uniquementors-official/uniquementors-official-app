...
export default function TermsOfServicePage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl ?rose ?rose-blue lg:?rose-lg">
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li><strong>Company</strong> (referred to as either " the Company", "We", "Us" or "Our" bi this Agreement) refers to uniquementors.</li>
        <li><strong>Device</strong> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</li>
        <li><strong>Service</strong> refers to the Website.</li>
        <li><strong>Website</strong> refers to uniquementors, accessible from https://uniquementors.com/</li>
      ...
      <p>Your access to and use of the Service is conditioned on Your acceptance of and compliance with these Terms and Conditions.</p>
      ...
      <ul className="list-disc pl-6 mb-4">
        <li>By visiting this page on our website: <a href="https://uniquementors.com/contact/" className="text-blue-600 hover:underline">https://uniquementors.com/contact/</a></li>
      </ul>
    </div>
  );
}