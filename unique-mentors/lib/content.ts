...
export const COURSES: Course[] = [
  ...
  {
    id: "course-physiotherapist",
    title: "Physiotherapist Licensing Exam Training",
    slug: "physiotherapist-licensing-exam-training",
    examType: "MOH",
    examTypes: ["MOH", "DHA", "HAAD"],
    ...
    fees: "Contact counselling team",
    nextBatch: "Every month",
    excerpt: "Comprehensive exam coaching for Physiotherapists targeting GCC.",
    description: "Prepare for your physiotherapy licensing exam with topic-wise coaching and mock tests.",
    eligibility: defaultEligibility,
    highlights: defaultHighlights,
    syllabus: defaultSyllabus,
    faqs: COMMON_FAQS,
  ...
  {
    id: "course-nurse",
    title: "Nurses Licensing Exam Training",
    slug: "nurses-licensing-exam-training",
    examType: "MOH",
    examTypes: ["MOH", "DHA", "HAAD"],
    profession: "Nurses",
    country: "GCC",
    ...
    fees: "Contact counselling team",
    nextBatch: "Every month",
    excerpt: "Licensing exam coaching for Nurses.",
    description: "Nursing licensing exam preparation for GCC countries.",
    eligibility: defaultEligibility,
    highlights: defaultHighlights,
    syllabus: defaultSyllabus,
    faqs: COMMON_FAQS,
  ...
  {
    id: "course-optometrist",
    title: "Optometrist Licensing Exam Training",
    slug: "optometrist-licensing-exam-training",
    examType: "MOH",
    examTypes: ["MOH", "DHA", "HAAD"],
    ...
    fees: "Contact counselling team",
    nextBatch: "Every month",
    excerpt: "Exam coaching for Optometrists.",
    description: "Prepare for your Optometry licensing exam.",
    eligibility: defaultEligibility,
    highlights: defaultHighlights,
    syllabus: defaultSyllabus,
    faqs: COMMON_FAQS,
    ...
    status: "published",
    coverImage: "https://images.unsplash.com/photo-1588421357574-87938a86fa28?auto=format&fit=crop&w=1200&q=80",
    imageAlt: "Optometrist"
  },
  {
    id: "course-anesthesia",
    title: "Anesthesia Tech Licensing Exam Training",
    slug: "anesthesia-licensing-exam-training",
    examType: "MOH",
    examTypes: ["MOH", "DHA", "HAAD"],
    profession: "Anesthesia Technicians and Technologists",
    country: "GCC",
    duration: "6 weeks",
    mode: "Online",
    fees: "Contact counselling team",
    nextBatch: "Every month",
    excerpt: "Exam coaching for Anesthesia Technicians.",
    description: "Prepare for your Anesthesia tech licensing exam.",
    eligibility: defaultEligibility,
    highlights: defaultHighlights,
    syllabus: defaultSyllabus,
    faqs: COMMON_FAQS,
    ...
    status: "published",
    coverImage: "https://images.unsplash.com/photo-1588421357574-87938a86fa28?auto=format&fit=crop&w=1200&q=80",
    imageAlt: "Anesthesia Tech"
  },
  {
    id: "course-apc",
    title: "APC - Australian Physiotherapy Council",
    slug: "apc-australian-physiotherapy-council",
    examType: "APC",
    examTypes: ["APC", "AUSTRALIA", "WESTERN"],
    ...
    fees: "Contact counselling team",
    nextBatch: "Open counselling slots",
    excerpt: "APC exam coaching for Physiotherapists targeting Australia.",
    description: "Prepare for the Australian Physiotherapy Council exams.",
    eligibility: defaultEligibility,
    highlights: defaultHighlights,
    syllabus: defaultSyllabus,
    faqs: COMMON_FAQS,
  ...
  {
    id: "course-amc",
    title: "AMC - Australian Medical Council",
    slug: "amc-exam-training",
    examType: "AMC",
    examTypes: ["AMC", "AUSTRALIA", "WESTERN"],
    ...
    fees: "Contact counselling team",
    nextBatch: "Open counselling slots",
    excerpt: "AMC exam coaching for Medical Professionals targeting Australia.",
    description: "Prepare for the Australian Medical Council exams.",
    eligibility: defaultEligibility,
    highlights: defaultHighlights,
    syllabus: defaultSyllabus,
    faqs: COMMON_FAQS,
  ...
  {
    id: "course-usmle",
    title: "USMLE Exam Training",
    slug: "usmle-exam-training",
    examType: "USMLE",
    examTypes: ["USMLE", "WESTERN"],
    profession: "General Practitioners",
    country: "USA",
    duration: "14 weeks",
    mode: "Online",
    fees: "Contact counselling team",
    nextBatch: "Open counselling slots",
    excerpt: "USMLE exam coaching for Medical Professionals targeting USA.",
    description: "Prepare for the USMLE exams.",
    eligibility: defaultEligibility,
    highlights: defaultHighlights,
    syllabus: defaultSyllabus,
    faqs: COMMON_FAQS,
  ...
  {
    id: "course-plab",
    title: "PLAB Exam Training",
    slug: "plab-exam-training",
    examType: "PLAB",
    examTypes: ["PLAB", "WESTERN"],
    profession: "General Practitioners",
    country: "UK",
    duration: "9 weeks",
    mode: "Online",
    fees: "Contact counselling team",
    nextBatch: "Open counselling slots",
    excerpt: "PLAB exam coaching for Medical Professionals targeting UK.",
    description: "Prepare for the PLAB exams.",
    eligibility: defaultEligibility,
    highlights: defaultHighlights,
    syllabus: defaultSyllabus,
    faqs: COMMON_FAQS,
